...
<div>
  ...
  <a href="#"><img style="position: absolute;margin-left: auto;margin-right: auto;left: 0%;right: 0%;width: 35%;height:4%;bottom:10%;top:15.2%;" src="bed.png"/></a>
  <a href="#"><img style="position: absolute;margin-left: auto;margin-right: auto;left: 0%;right: 0%;width: 95%;height:55%;bottom:0%;top:24%;" src="http://192.168.101.69:8081"/></a>-->
  <img style="position: absolute;margin-left: auto;margin-right: auto;left: 0%;right: 0%;width:80%;height:10%;top:20%;" src="control_led.png"/>
  
         
  <form method="get" action="control.php" style="position: absolute;margin-left: auto;margin-right: auto;left: 15%;top:40%;width:60%;height:60%">                 
  <input type="submit" style="position: absolute;margin-left: auto;margin-right: auto; left:10%; height:40%; width: 45%; font-size: 200%" value="OFF" name="off">
  <input type="submit" style="position: absolute;margin-left: auto;margin-right: auto; left:56%; height:40%; width: 45%; font-size: 200%" value="ON" name="on">
  </form>
  <?php
